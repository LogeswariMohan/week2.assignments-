...
//        18. Clear the CompanyName Field using .clear() And Enter new CompanyName
		WebElement clearCompanyElement = driver.findElement(By.id("createLeadForm_companyName"));
		clearCompanyElement.clear();
		 
		 WebElement newCompanyElement = driver.findElement(By.id("createLeadForm_companyName"));
		 newCompanyElement.sendKeys("The GLUM technologies");
		 
//        19.Clear the FirstName Field using .clear() And Enter new FirstName
		 WebElement clearFirstElement = driver.findElement(By.id("createLeadForm_firstName"));
		 clearFirstElement.clear();
		 
		 WebElement newFirstElement = driver.findElement(By.id("createLeadForm_firstName"));
		 newFirstElement.sendKeys("LOGESWARI");
		 
		 
//        20.Click on Create Lead Button
		 WebElement createLeads = driver.findElement(By.name("submitButton"));
		 createLeads.click();
